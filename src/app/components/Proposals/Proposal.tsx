        ...
        >
            ...
            <div className="proposal-process">
                            ...
                            <div className="proposal-votes-for">
                                {
                                    (
                                      ...
                                      ? (
                                        `${convertTokensToThousandsK(proposalMetadata[index].forVotes as string)}`
                                        )
                                      : (
                                          ''
                                        )
                            ...
                            <div className="proposal-votes-against">
                                {
                                    (
                                      ...
                                      ? (
                                        `${convertTokensToThousandsK(proposalMetadata[index].againstVotes as string)}`
                                        )
                                      : (
                                          ''
                                        )
                                    ...
                                    (
                                      ...
                                      ? (
                                        `${convertTokensToThousandsK(
                                            (proposalMetadata[index].againstVotes + proposalMetadata[index].forVotes) as string
                                        )}`
                                        )
                                      : (
                                          ''
                ...
                }
                {
                    ...
                    <div className="proposal-executed proposal-state">Executed</div>
                }
                {
                    proposalMetadata.length > 0 &&
                    proposalMetadata[index].proposer !== '' &&
                    proposalMetadata[index].cancelled === true &&
                    <div className="proposal-cancelled proposal-state">Cancelled</div>
                }
                {
                    proposalMetadata.length > 0 &&
                    proposalMetadata[index].proposer !== '' &&
                    ...
                    <div className="proposal-pending proposal-state">Pending</div>
                }
            </div>
        </Link>
  )
